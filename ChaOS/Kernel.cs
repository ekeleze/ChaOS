...
namespace ChaOS
{
    public class Kernel : Sys.Kernel
    {
        ...
        public const int Width = 1200, Height = 900;
        ...
        protected override void BeforeRun()
        {
            try
            {
                Screen = Display.GetDisplay(800, 600);
                Console = new SVGAIITerminal(800, 600, Font_1x, FallbackTerminalUpdate);
                ...
                log("   Custom .net core 6 runtime");
                log("   and more");

                Console.SetCursorPosition(0, 32);
                log("Currently ChaOS is unavailable.");
                log("You may enter dev mode to test ChaOS, however it is unstable and may corrupt data or not work.\n");
                write("To enter dev mode, press CTRL + D...");
            }
            catch (Exception ex)
            {
                Crash(ex);
