...
namespace ChaOS
{
    public class Kernel : Sys.Kernel
    {
        ...
        private UserFunctionHandler UsrCMDHandler = new UserFunctionHandler();
        public static string UserCMDreturn = "unknown";
        ...
        protected override void Run()
        {
            ...
            try
            {
                ...
                {
                    UsrCMDHandler.Try(input);
                    if (UserCMDreturn == "Known")
                    {
                        
                    }
                    else if (UserCMDreturn == "Unknown")
                    {
                        Console.Beep();
